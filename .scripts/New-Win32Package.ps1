        ...
        if (Test-Path -Path $ManifestFile -PathType "Leaf") {
            ...
            if ($UpdateApp -eq $true -or $Force -eq $true) {
                ...
                if ($Import -eq $true) {
                    ...
                    Write-Information -MessageData "$($PSStyle.Foreground.Cyan)Create package with: '$PSScriptRoot\Create-Win32App.ps1'"
                    ...
                    & "$PSScriptRoot\Create-Win32App.ps1" @params | Select-Object -Property * -ExcludeProperty "largeIcon"
                }
                #endregion
            }
        }
